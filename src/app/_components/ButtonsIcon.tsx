...
export function DeleteButton(props: ButtonProps) {
  return (
    ...
    >
      <FontAwesomeIcon color="black" size="2x" icon={faTrash} />
    </button>
  );
}
...
export function ArchiveButton(props: ButtonProps) {
  return (
    <button
      ...
      className={`${styles.button} ${props.className}`}
    >
      <FontAwesomeIcon color="black" size="2x" icon={faBoxArchive} />
    </button>
  );
}
...
export function ChevronButton(props: ButtonProps) {
  return (
    <button type="button" onClick={props.onClick} className={styles.button}>
      <FontAwesomeIcon color="black" size="2x" icon={faChevronLeft} />
    </button>
  );
}
